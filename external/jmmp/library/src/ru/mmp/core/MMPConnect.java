...
public class MMPConnect implements Runnable {
	...
	private String host = "mrim.mail.ru";//"94.100.187.38";
	private int port = 443;//2041;
	...
	public synchronized void connect() throws IOException {
		...
		socketClient.setSoLinger(true, 60000);
	...
	public void sendPacket(Packet p) {
		try {
			...
			Log.d("MMPConnect","sending packet: " + Integer.toHexString(p.getCommand()));
